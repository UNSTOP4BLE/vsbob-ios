...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		bgBack = new FlxSprite(320, 180).loadGraphic(Paths.image('bob/select', 'shared'));
		bgBack.scale.set(2,2);
		add(bgBack);
		...
		mainthingidk = new FlxSprite(320, 180).loadGraphic(Paths.image('bob/SelectScreen_Bob', 'shared'));
		mainthingidk.scale.set(2,2);
		add(mainthingidk);
