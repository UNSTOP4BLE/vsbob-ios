...
class FlxJoyStick extends FlxSpriteGroup
{
	...
	function createBase():Void
	{
		base = new FlxSprite(0,
			0).loadGraphic(FlxGraphic.fromFrame(FlxAtlasFrames.fromSparrow(Assets.getBitmapData('assets/ios/joystick.png'),
				Assets.getText('assets/ios/joystick.xml'))
				.getByName('base')));
		...
		base.solid = false;
		base.immovable = true;
		base.alpha = IosControls.getOpacity();
		#if FLX_DEBUG
	...
	function createThumb():Void
	{
		...
		thumb.alpha = IosControls.getOpacity();
		#if FLX_DEBUG
